...
def ft_data_stream() -> None:
    ...
    for event in get_events(game_events):
        event_count += 1
    ...
    print(f"Treasure events: {treasur_events}")
    print(f"Level-up events: {lvl_up_event}\n")
    ...
    def fibb_gen() -> Generator[int, None, None]:
        a, b = 0, 1
        while True:
            yield a
            a, b = b, a + b
    ...
    def prim_gen() -> Generator[int, None, None]:
        x = 2
        while 1:
            if is_prime(x):
                yield x
